...
{if !empty($needToConfirmCookies)}
    <script>
        $(function () {
            alert('Мы используем файлы cookies для улучшения работы сайта. Оставаясь на нашем сайте, ' +
                'вы соглашаетесь с условиями использования файлов cookie, мы используем яндекс-метрику');
        });
    </script>
{/if}
