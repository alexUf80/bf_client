...
<table>
    <tr>
        <td width="20%"><strong>{$document->created|date}</strong></td>
        <td width="60%"></td>
    ...
    <tr style="width: 100%;">
        ...
        <td style="width: 36%" align="center">
            <div>ПОЛНАЯ СТОИМОСТЬ ЗАЙМА
                ...
                {/if}
                НОЛЬ ТЫСЯЧНЫХ ПРОЦЕНТА ГОДОВЫХ
            </div>
        </td>
...
<div align="justify">По договору потребительского кредита (займа), срок возврата потребительского кредита (займа) по
    ...
    (далее - фиксируемая сумма платежей), достигнет 
...
<table border="1" cellpadding="5">
    ...
    <tr>
        ...
        <td width="50%">Сумма займа составляет {$P2P|upper} ({$P2P|price_string|upper}). Лимит кредитования
            - не применимо.
        </td>
    </tr>
    <tr>
        ...
        <td width="50%">с {$prolo->start_date|date} г. по {$prolo->return_date|date} г.
    ...
    <tr>
        ...
        <td width="50%">
            ...
            {if $contract->base_percent == 0.8}
                292% (Двести девяносто два процента) годовых (0,8% (Ноль целых восемь десятых процента) в день)
            {else}
                365% (Триста шестьдесят пять процентов) годовых (1% (Один процент) в день)
            {/if}
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="50%">Единовременно в конце срока предоставления займа — {$prolo->return_date|date} заемщик
            осуществляет платеж в размере {$prolo->return_amount} рублей , включающий в себя погашение
            суммы займа в размере {$prolo->amount} рублей, и погашение процентов в размере {$prolo->return_amount_percents}
    ...
    <tr>
        ...
        <td width="50%">1.Путем перевода денежных средств платежными картами VISA, MasterCard, МИР на сайте Займодавца www. barents-finans.ru.
            <br><br>2.Путем перечисления денежных средств на расчетный счет Кредитора по реквизитам: р/с 40701810702500001111, наименование банка

            <br>ООО «Банк Точка»,

            <br>к/с 30101810745374525104,
            <br>ИНН 9723120835, БИК 044525104.

            <br>Получатель: ООО МКК «Баренц Финанс»
            <br>Назначение платежа: оплата по договору займа № {$contract->number} от {$contract->inssuance_date|date} {$lastname|upper} {$firstname|upper} {$patronymic|upper}
            <br><br>3.Путем совершения платежа с использованием интернет-банка Сбербанка Онлайн, мобильного приложения Сбербанк Онлайн или внесения наличных денежных средств с помощью устройства самообслуживания Сбербанка.

            <br>Путем совершения почтовых переводов денежных средств физических лиц в адрес Займодавца с применением технологии электронной пересылки переводов в Единой системе почтовых переводов АО «Почта России». Перевод в адрес Федерального клиента № 37332.

            <br>Я предоставляю Кредитору акцепт (заранее данный акцепт) на списание денежных средств с моей банковской карты, которая использована мною при получении займа, без дополнительного распоряжения в счет погашения задолженности по Договору займа, а также в случае ошибочного зачисления Кредитором денежных средств на мою банковскую карту, данные операции не могут быть мною оспорены.
        </td>
    </tr>
    <tr>
        ...
        <td width="50%">Почтовый перевод денежных средств физическим лицом в адрес Займодавца с применением технологии электронной пересылки переводов в Единой системе почтовых переводов АО «Почта России». Перевод в адрес Федерального клиента ООО МКК «Баренц Финанс» № 37332.
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="50%">Кредитор вправе осуществлять уступку прав (требований) по договору
            ...
            27.12.2018 N 554-ФЗ.<br><br>X Да <br>     Нет
        </td>
    </tr>
    <tr>
