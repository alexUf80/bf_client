            ...
            <form action="" method="POST" class="regform js-form-app js-stage-work-form">
              ...
              <div class="step_box step4">
                <div class="form_group -fs-18 js-dadata-work">
                  ...
                  <div class="form_row">
                    <label class="input_box">
                      <input type="text" class="ss form-control js-input-digits js-input-required" name="income" id="income" value="{$income}" />
                  ...
                  <div class="form_row">
                    <label class="input_box">
                      <input type="text" class="form-control js-input-digits" name="average_pay" id="average_pay" value="{$average_pay}" />
                      <span class="input_name {if $average_pay}-top{/if}">Среднемесячный платеж по кредитам и займам</span>
                    </label>
                    <label class="input_box">
                      <input type="text" class="form-control js-input-digits" name="amount_pay" id="amount_pay" value="{$amount_pay}" />
