                                ...
                                <ul class="docs_list">
                                    ...
                                    {if isset($documents_old)}
                                        ...
                                        {foreach $documents_old as $document_old}
                                            {if in_array($document_old->type, ['ANKETA_PEP_24-01-21', 'IND_USLOVIYA_NL_24-01-21', 'DOP_SOGLASHENIE', 'POLIS_24-01-21', 'KID_24-01-21', 'UVEDOMLENIE_OTKAZ_OT_USLUG'])}
                                                <li class="docs_list_item">
                                        ...
                                        {foreach $receipts as $receipt}
                                            <li class="docs_list_item">
                                                <a href="{$receipt->receipt_url}"
                                                   class="docs_list_link" target="_blank">
                                                    Чек за {$receipt->created|date} за {$receipt->name}
                                                </a>
                                            </li>
                                        {/foreach}
                                    </ul>
