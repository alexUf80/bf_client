                            ...
                            <div class="col-md-6">
                                <ul class="docs_list js-docs-list">
                                    ...
                                    <li class="docs_list_item">
                                        <a href="{$config->root_url}/files/docs/Pravila_strahovaniya_ot_neschastnyh_sluchaev.pdf"
                                    ...
                                    <li class="docs_list_item">
                                        <a href="{$config->root_url}/files/docs/Pravila_strahovanie_bankovskih_kart.pdf"
                                           class="docs_list_link" target="_blank">
                                    ...
                                    <li class="docs_list_item">
                                        <a href="{$config->root_url}/files/docs/Pravila_predostavleniya_uslugi_byt_v_kurse.pdf"
                                           class="docs_list_link" target="_blank">
                                    ...
                                    <li class="docs_list_item">
                                        <a href="{$config->root_url}/files/docs/Pravila_predostavleniya_zajmov.pdf"
                                           class="docs_list_link" target="_blank">
                                    ...
                                    <li class="docs_list_item">
                                        <a href="{$config->root_url}/files/docs/Obshchie_usloviya_dogovora_potrebitelskogo_zajma.pdf"
                                           class="docs_list_link" target="_blank">
                                    ...
                                    <li class="docs_list_item">
                                        <a href="{$config->root_url}/files/docs/INFORMACIYA_OB_USLOVIYAH_PREDOSTAVLENIYA_ISPOLZOVANIYA_I_VOZVRATA.pdf"
                                           class="docs_list_link" target="_blank">
                                    ...
                                    <li class="docs_list_item">
                                        <a href="{$config->root_url}/files/docs/soglashenie_o_ispolzovanii_pep.pdf"
                                           class="docs_list_link" target="_blank">
                                            <span>Соглашение о АСП</span>
                                        </a>
                                    </li>

                                    {if in_array($user->id, $userIdsForClaims)}
                                        <li class="docs_list_item">
                                            <a href="{$config->root_url}/files/docs/Uvedomlenie_ob_ustupke_prava_trebovaniya.pdf"
                                               class="docs_list_link" target="_blank">
                                                <span>Уведомление об уступке права требования</span>
                                            </a>
                                        </li>
                                    {/if}
